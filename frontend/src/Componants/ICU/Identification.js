...
const Identification = () => {
    ...
    const onSubmit = async (data) => {
      let res;
      try {
        res = await api.post("http://localhost:5500/api/patient/identification",data)
        if(res.status === 200){
  ...
  return (
    ...
    <form  style={{display:"flex", flexDirection:"column"}}>
      ...
      <input type="date" {...register("dateOfAdmission", { required: false })}  min={new Date().toISOString().split('T')[0]}/>
      ...
      <textarea type="text" {...register("Chief Complaints", { required: false })} />
      <label>History of present illness</label>
      <textarea type="text" {...register("History of present illness", { required: false })} />
      <label>Allergy</label>
     ...
     {/* //1 */}
      ...
      <input type="text" {...register("Sodium bicarbonate", { required: false })} />
      <label>Other</label>
      ...
      <input type="text" {...register("Fluid restriction", { required: false })} />

           
      <button type="submit" onClick={handleSubmit(onSubmitISBAR)}>Submit</button>
   ...
   <h3 style={{color:"white"}} >SITUTION</h3>
      ...
      <input type="text" {...register("Random blood sugar", { required: false })} />
      ...
      <input type="text" {...register("Sodium Potassium", { required: false })} />
      ...
      <input type="text" {...register("Coagulation Profile", { required: false })} />
      <label>Other</label>
      <input type="text" {...register("Other", { required: false })} />
...
{/* //2 */}
      ...
      <input type="text" {...register("Past medical history", { required: false })} />
      <label>Past surgical history</label>
      <input type="text" {...register("Past surgical history", { required: false })} />
      ...
      <input type="text" {...register("pack red blood cells", { required: false })} /> 
      <label>fresh frozen plasma</label>
      <input type="text" {...register("fresh frozen plasma", { required: false })} />
      <label>single frozen plasma</label>
      <input type="text" {...register("single frozen plasma", { required: false })} />
      <label>cryoprecipitate antihemophilic factor</label>
      <input type="text" {...register("cryoprecipitate antihemophilic factor", { required: false })} />
      <button type="submit" onClick={handleSubmit(onSubmitISBAR)}>Submit</button>    
    ...
    <label>Pending medication</label>
      <input type="text" {...register("Pending medication", { required: false })} />
      <label>Pending reports</label>
      <input type="text" {...register("Pending reports", { required: false })} /> 
      ...
      <input type="text" {...register("Pending procedures", { required: false })} />
